...
**P1 — CE QUI EST RECONFIGURÉ**

L'intégration de l'IA dans les missions de conseil reconfigure la valeur perçue par le client selon trois dimensions interdépendantes : relationnelle, processuelle et cognitive.

**P2 — LE MÉCANISME**

La transparence est le mécanisme médiateur de la valeur perçue du conseil à l’ère de l’IA.

**P3 — LES CONDITIONS**

Trois catégories de contingence déterminent si P2 produit une attribution correcte : au niveau relationnel, au niveau situationnel et au niveau acteur.
...
#### Séquencement d'observation — Situation initiale de co-création
