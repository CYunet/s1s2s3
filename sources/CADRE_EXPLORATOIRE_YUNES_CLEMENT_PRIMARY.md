...
Note : ce texte est disponible également en ligne sous forme interactive, c’est-à-dire, permettant au lecteur de le questionner ((assistant IA) : https://s1s2s3.vercel.app

[p. 2]
1. POSITIONNEMENT DE LA RECHERCHE	2
Comprendre les effets de l’intégration de l’IA dans les pratiques du conseil, sur la valeur perçue	2
En quoi est-ce une exploration nécessaire ?	2
[p. 3]
Implications théoriques et praxéologiques	3
[p. 4]
2. PROPOSITION D’UN CADRE D’ANALYSE	4
Cadre théorique mobilisé	4
La valeur perçue du conseil est une notion subjective et dynamique, dont les mécanismes restent à explorer	4
La valeur perçue du conseil est avant tout un accomplissement social	4
[p. 5]
L’IA, élément perturbateur de l’accomplissement social	5
[p. 6]
Propositions de recherche	6
TROIS PROPOSITIONS, P1, P2, P3	6
[p. 7]
LE MODÈLE R → P → C	7
[p. 11]
3. CADRE D'OBSERVATION S1, S2, S3	11
Les 3 sphères de co-création de valeur perçue du conseil à l’ère de l’IA	11
S1 — Sans IA	12
S2 — IA en silo	12
S3 — Co-création tripartite	12
[p. 14]
4. ILLUSTRATION	14
Scénario fictif d'une mission de conseil : audit de plateforme digitale sur 10 semaines	14
[p. 15]
Exploration de la reconfiguration de la valeur perçue au travers de la mission	15
Évaluation rétrospective de la valeur perçue sur les trois dimensions.	17
BIBLIOGRAPHIE	18
...
Un autre angle de vue considère l’enjeu des interactions dans la valeur perçue, comme plus subtil : pour que le client puisse percevoir la valeur du conseil, celle-ci doit être activement produite, à travers des micro-activités délibérées de mise en valeur (au sens de surcroit de justification), par lesquelles le consultant construit sa légitimité tout au long de la mission, classées en cinq catégories de pratique (Bourgoin, 2014) : la formulation commerciale du service, la présentation graphique du diagnostic, le signalement de l’activité, la montée en compétence du consultant et la production de son autorité. Cette approche est d’autant plus pertinente que  le contexte du conseil se nourrit d’ambiguïté, et donc réclame des mythes et discours particuliers, dont la fonction est de persuader la clientèle de la valeur du service fourni (Bourgoin, 2014).  
L’IA, élément perturbateur de l’accomplissement social 
Or, l’intégration de l’IA dans les pratiques du conseil, vient perturber dans les deux cas, le processus à l’œuvre dans les interactions entre consultant et client : la réalisation des activités cognitives conjointes de résolution du problème peut désormais s’appuyer sur l’IA et moins sur le jugement humain (par exemple, automatisation de l’étape de clarification du diagnostic). La symétrie de l’interaction consultant-client devient sujette à déstabilisation. Les pratiques de justification, elles aussi à la portée d’une automatisation par l’IA, sont vouées à changer de nature. 
L’IA, devient ainsi acteur à part entière du processus de co-création de valeur perçue et rend ainsi difficile la répartition des résultats aux acteurs (Raisch & Krakowski, 2020). Le phénomène ouvre par conséquent la voie à une reconfiguration des rôles et responsabilités du processus interactionnel. (Baird & Maruping, 2021; Pakarinen & Huising, 2023). 
La source même de la valeur perçue est donc en état de reconfiguration : il s’agit bien d’un redéploiement des ressources existantes en de nouvelles combinaisons de compétences opérationnelles, permettant de mieux s’adapter à l’environnement (Pavlou & El Sawy, 2006). Notre travail cherche donc à explorer la dynamique de reconfiguration à l’oeuvre. 
Nous nous devons néanmoins de clarifier un point : pour le conseil, l’enjeu du processus de co-création n’est pas remis en cause. Il s’agit bien toujours, in-fine, de faire émerger les connaissances managériales nécessaires au client, pour permettre au client de percevoir la valeur du conseil. Simplement, la manière d’y arriver diffère à l’ère de l’IA, et appelle donc à une clarification. 

Propositions de recherche
Pour explorer la manière dont l'intégration de l'IA reconfigure la valeur perçue dans le conseil, nous formulons un cadre propositionnel intégré, où P1 est la composante ontologique, P2 la composante mécanistique et P3 la composante contingente.
Ce cadre, dérivé de la revue de la littérature, forme un système articulé et hiérarchisé : 
	...
	•	P3 spécifie sous quelles conditions ce mécanisme fonctionne (littératie IA, aversion à l'algorithme).articule ainsi les  séquentiel (P1, P2, P3). 
LE CADRE PROPOSITIONNEL INTEGRÉ : P1, P2, P3
...
L'expérience même de co-création, sa nature, sa lisibilité et la distribution des rôles, reconfigurée par l'IA comme troisième acteur.
→
C — Cognitive

La capacité à interpréter, comprendre et évaluer ce qui a été co-produit, afin que les productions de la mission deviennent intelligibles, évaluables, appropriables et mobilisables (par le client) comme connaissances managériales.
...
Dépend de l’explicitation substantive du consultant (P2) et, via P3, de l’intelligibilité, de l’acceptation et des conditions relationnelles et situationnelles.

Tableau 1 : comment l'IA reconfigure de façon contingente la chaine de la valeur perçue du conseil à l'ère de l'IA, R-P-C
...
Figure 1: Les 3 sphères de la co-création consultant-client-IA
[p. 12]
...
Exploration de la reconfiguration de la valeur perçue au travers de la mission
1. Cadrage – Sem. 1-3
